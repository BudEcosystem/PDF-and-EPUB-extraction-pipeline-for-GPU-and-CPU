...
from utils import timeit, mongo_init, parse_table, generate_unique_id, get_file_object_aws, get_toc_from_ncx, get_toc_from_xhtml
...
if __name__ == '__main__':
    ...
    print(f'total microsoft extracted books {len(extracted)}')
