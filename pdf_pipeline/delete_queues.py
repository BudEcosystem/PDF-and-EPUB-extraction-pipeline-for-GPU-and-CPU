...
if __name__ == "__main__":
    queue_names = ['pdf_processing_queue', 'publeynet_queue', 'table_bank_queue', 'mfd_queue', 'pdfigcap_queue', 'nougat_queue', 'check_ptm_completion_queue', 'book_completion_queue']
